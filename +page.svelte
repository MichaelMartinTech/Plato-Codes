...
*/
  ...
  const handleContinue = async () => {
    if (image) {
      ...
      data.append('api_user', 'REDACTED'); //User data - REDACTED for Security
      data.append('api_secret', 'REDACTED'); //API secret - REDACTED for Security
      ...
      axios({
        ...
        .then((response) => {
          ...
          //Nice, it works. Now to upload the image:
